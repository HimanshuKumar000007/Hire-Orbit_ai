/**
 * API Proxy: /api/ai-grade-answer
 * Forwards POST request (with Authorization, question, and answer) to the Express backend.
...
export async function POST(req) {
  try {
    ...
    const backendRes = await fetch(`${BACKEND}/api/ai/grade-answer`, {
      method: "POST",
      headers: {
    ...
    console.error("❌ ai-grade-answer proxy error:", err.message);
