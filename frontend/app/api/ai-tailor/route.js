/**
 * API Proxy: /api/ai-tailor
 * Forwards POST request (with Authorization and jobDescription) to the Express backend.
...
export async function POST(req) {
  try {
    ...
    const backendRes = await fetch(`${BACKEND}/api/ai/tailor-resume`, {
      method: "POST",
      headers: {
    ...
    console.error("❌ ai-tailor proxy error:", err.message);
