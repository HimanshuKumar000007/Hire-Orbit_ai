/**
 * API Proxy: /api/ai-copilot
 * Forwards POST request (with Authorization and messages array) to the Express backend.
...
export async function POST(req) {
  try {
    ...
    console.error("❌ ai-copilot proxy error:", err.message);
