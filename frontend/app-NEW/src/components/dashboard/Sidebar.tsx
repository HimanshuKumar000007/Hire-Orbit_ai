...
const mainNavItems: NavItem[] = [
  ...
  { id: 'jobs', label: 'Jobs', icon: Briefcase, badge: 4 },
...
export function Sidebar({ activeItem = 'dashboard', onItemClick }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 z-50 h-screen w-72 bg-zinc-950 border-r border-white/5 flex flex-col"
    >
      {/* Logo */}
      <div className="p-6">
        <motion.div
      ...
      <div className="p-4 border-t border-white/5">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-zinc-500 truncate">alex.chen@email.com</p>
          </div>
