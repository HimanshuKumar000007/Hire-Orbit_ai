...
const features = [
  {
    ...
    description: 'Instantly tailor your experience bullet points using the STAR method and generate custom cover letters optimized for any Job Description.',
  ...
  },
  {
    ...
    description: 'Prep for target roles with an interactive quiz room. Get immediate AI grading, feedback (on structure and tone), and model answers.',
  ...
  },
  {
    ...
    description: 'Chat in real-time with your personal career coach. Draft outreach emails, strategize role transitions, and map learning paths.',
    color: 'from-cyan-500 to-blue-500',
    highlight: false,
  },
  {
    icon: Globe,
    title: 'Verified Shareable Portfolio',
    description: 'Directly compete with LinkedIn profiles. Generate a beautiful, public, verified portfolio landing page to share with recruiters.',
  ...
  },
  {
    ...
    description: 'Gain a clear visual radar chart of missing skills required for your dream job with step-by-step learning schedules.',
  ...
  },
  {
    ...
    description: 'Leverages vector embeddings to match resumes to live Google Jobs postings based on contextual fit, going beyond keyword matches.',
