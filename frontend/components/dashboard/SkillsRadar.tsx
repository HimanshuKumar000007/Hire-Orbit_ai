...
export function SkillsRadar({ skills }: SkillsRadarProps) {
  ...
  const avgLevel = matchedSkills.length > 0 
    ? Math.round(matchedSkills.reduce((acc, s) => acc + s.level, 0) / matchedSkills.length)
    : 0;
          ...
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart cx="50%" cy="50%" outerRadius="70%" data={radarData}>
              ...
              <Radar
                ...
                stroke="#10b981"
                strokeWidth={2}
                fill="url(#radarGradient-skills)"
                fillOpacity={0.3}
              />
              <defs>
                <linearGradient id="radarGradient-skills" x1="0" y1="0" x2="0" y2="1">
